...
if ($_GET['action'] == 'add')
{
	...
	{
		(header("Location: ../auf_neu-job.php?message=1"));
	}
	else
	{
		...
		$sql	=	"INSERT INTO `auf_items` (`id`, `datum`, `prio`, `bemerkung`, `erledigt`, `auftrag`, `creator`) VALUES (NULL, '".$datum."', '".$prio."', '".$bemerkung."', NULL, '".$auftrag."','".$uID."');";
		$DB->query($sql);
