...
{
	echo "<a href='rhl_lager-liste.php?holzart=".$holzarten['id']."'>".$holzarten['name']."</a> ";
}
echo "</p>\n";
// End Menü
...
if (isset($_GET['holzart']))
{
	if (is_numeric($_GET['holzart']))
	{
		...
		echo "<h1>Lager Liste: ".$result[0]['name']." Total: ".round($result_total_holzart[0]['total_holzart'],1)." m3 (<a href='/xls/rhl_lager-liste_xls.php?holzart=".$_GET['holzart']."'>.xls</a>)</h1>\n";
