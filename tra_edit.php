...
$PAGE_TITLE = "Transportauftrag &auml;ndern";
...
// Seitenüberschrift
echo "<h1>Transportauftrag &auml;ndern.</h1>";
...
$sql	=	"SELECT * FROM `tra_items` WHERE `id` = ".$id."";
$result	=	$DB->query($sql);
...
<fieldset style='padding:2px;width:600px;border:1px solid grey;'>
	...
	<form action="/scripts/tra-edit.php?action=upd" method="post">
	<table>
	<tr>
		<td>Erledigt?</td>
