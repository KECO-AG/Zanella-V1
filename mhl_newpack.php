...
// Seitentitel
$PAGE_TITLE = "Massivholz Lager - Neues Paket";
...
// Seitenüberschrift
echo "<h1>Massivholz Lager - Neues Paket</h1>";
...
if(isset($_GET['lastITEM']))
{
	$sql_lastITEM = "
		...
		WHERE
		  mhl_items.id = ".$DB->escapeString($_GET['lastITEM'])." AND
...
<fieldset style='padding:5px;width:500px;border:1px solid grey;'>
    ...
    <form name="newentry" action="/scripts/script-mhl.php?action=neuesPaket" method="post">
    <table>
      <tr>
