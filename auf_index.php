...
<head>
	...
	<link rel="stylesheet" href="./inc/css/redips/style-auf.css" type="text/css" media="screen" />
	...
	<script type="text/javascript" src="./inc/js/redips-init-auf.js"></script>
	<title>Auftragsverwaltung :: Zanella Holz AG</title>
...
?>
	...
	<colgroup><col width="100"/></colgroup>
		<tr>
			<td class="mark"><form name="search" action="auf_such_resultate.php" method="get"><b>Suchen:</b> <input type="text" name="searchvalue" /> </form></td>
...
for ($i = 1; $i <= $anz_wochen; $i++)
{
	...
	echo "	<tr>\n";
	echo "		<td class='mark'><b>".$montag->format('d.m.Y')."</b>&nbsp;&nbsp;<a href='./print/print_auf.php?print=day&amp;day=".$montag->format('d.m.Y')."' target='_blank'><img src='./images/print_icon.png' width='16' /></a></td>\n";
	echo "		<td class='mark'><b>".$dienstag->format('d.m.Y')."</b>&nbsp;&nbsp;<a href='./print/print_auf.php?print=day&amp;day=".$dienstag->format('d.m.Y')."' target='_blank'><img src='./images/print_icon.png' width='16' /></a></td>\n";
	echo "		<td class='mark'><b>".$mittwoch->format('d.m.Y')."</b>&nbsp;&nbsp;<a href='./print/print_auf.php?print=day&amp;day=".$mittwoch->format('d.m.Y')."' target='_blank'><img src='./images/print_icon.png' width='16' /></a></td>\n";
	echo "		<td class='mark'><b>".$donnerstag->format('d.m.Y')."</b>&nbsp;&nbsp;<a href='./print/print_auf.php?print=day&amp;day=".$donnerstag->format('d.m.Y')."' target='_blank'><img src='./images/print_icon.png' width='16' /></a></td>\n";
	echo "		<td class='mark'><b>".$freitag->format('d.m.Y')."</b>&nbsp;&nbsp;<a href='./print/print_auf.php?print=day&amp;day=".$freitag->format('d.m.Y')."' target='_blank'><img src='./images/print_icon.png' width='16' /></a></td>\n";
	echo "		<td class='mark'><b>".$woche->format('W')."</b>&nbsp;&nbsp;<a href='./print/print_auf.php?print=week&amp;week=".$montag->format('d.m.Y')."' target='_blank'><img src='./images/print_icon.png' width='16' /></a></td>\n";
	echo "		<td class='mark'><b>".$abruf->format('W')."</b>&nbsp;&nbsp;<a href='./print/print_auf.php?print=week&amp;week=".$montag->format('d.m.Y')."' target='_blank'><img src='./images/print_icon.png' width='16' /></a></td>\n";
	echo "	</tr>\n";

	echo "	<tr>\n";
	if ($heute > $montag) 		{echo "	<td class='mark'>"; $AUF->getItemsExpired($montag->format('Y-m-d')); $AUF->getItemsErledigt($montag->format('Y-m-d')); echo "</td>\n";} else {echo "	<td>"; $AUF->getItems($montag->format('Y-m-d')); $AUF->getItemsErledigt($montag->format('Y-m-d')); echo "</td>\n";}
	if ($heute > $dienstag) 	{echo "	<td class='mark'>"; $AUF->getItemsExpired($dienstag->format('Y-m-d')); $AUF->getItemsErledigt($dienstag->format('Y-m-d')); echo "</td>\n";} else {echo "	<td>"; $AUF->getItems($dienstag->format('Y-m-d')); $AUF->getItemsErledigt($dienstag->format('Y-m-d')); echo "</td>\n";}
	if ($heute > $mittwoch) 	{echo "	<td class='mark'>"; $AUF->getItemsExpired($mittwoch->format('Y-m-d')); $AUF->getItemsErledigt($mittwoch->format('Y-m-d')); echo "</td>\n";} else {echo "	<td>"; $AUF->getItems($mittwoch->format('Y-m-d')); $AUF->getItemsErledigt($mittwoch->format('Y-m-d')); echo "</td>\n";}
	if ($heute > $donnerstag) 	{echo "	<td class='mark'>"; $AUF->getItemsExpired($donnerstag->format('Y-m-d')); $AUF->getItemsErledigt($donnerstag->format('Y-m-d')); echo "</td>\n";} else {echo "	<td>"; $AUF->getItems($donnerstag->format('Y-m-d')); $AUF->getItemsErledigt($donnerstag->format('Y-m-d')); echo "</td>\n";}
	if ($heute > $freitag) 		{echo "	<td class='mark'>"; $AUF->getItemsExpired($freitag->format('Y-m-d')); $AUF->getItemsErledigt($freitag->format('Y-m-d')); echo "</td>\n";} else {echo "	<td>"; $AUF->getItems($freitag->format('Y-m-d')); $AUF->getItemsErledigt($freitag->format('Y-m-d')); echo "</td>\n";}
	if ($heute > $woche) 		{echo "	<td class='mark'>"; $AUF->getItemsExpired($woche->format('Y-m-d')); $AUF->getItemsErledigt($woche->format('Y-m-d')); echo "</td>\n";} else {echo "	<td>"; $AUF->getItems($woche->format('Y-m-d')); $AUF->getItemsErledigt($woche->format('Y-m-d')); echo "</td>\n";}
	if ($heute > $abruf) 		{echo "	<td class='mark'>"; $AUF->getItemsExpired($abruf->format('Y-m-d')); $AUF->getItemsErledigt($abruf->format('Y-m-d')); echo "</td>\n";} else {echo "	<td>"; $AUF->getItems($abruf->format('Y-m-d')); $AUF->getItemsErledigt($abruf->format('Y-m-d')); echo "</td>\n";}
	echo "	<tr>\n";
...
?>
	...
	<form action="/scripts/auf-neu.php?action=add" method="post" id="new">
	<table>
	<tr>
		<td>
		Priorit&auml;t:&nbsp;&nbsp;&nbsp;
	...
	<form action="/scripts/auf-edit.php?action=upd-new" method="post" id="edit">
	<table>
	<tr>
		<td>Erledigt?</td>
