...
else if(target_cell.className.indexOf(REDIPS.drag.trash_cname)>-1){obj.parentNode.removeChild(obj);if(REDIPS.drag.trash_ask){setTimeout(function(){if(confirm('Wirklich loeschen?')){REDIPS.drag.myhandler_deleted();if(cloned_flag===1){clone_limit();}}
