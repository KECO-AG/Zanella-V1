...
// Seitenüberschrift
echo "<h1>Holzarten Verwaltung</h1>";
...
<div align="center">
	...
	<legend>Neue Holzart hinzuf&uuml;gen</legend>
		<form action="/scripts/za-holzarten.php?action=add" method="post">
		<p>
...
<table class="grey">
  ...
  <?php 
  $sql = "SELECT * FROM za_holzarten ORDER BY  sort ASC";
  $result = $DB->query($sql);
  ...
  <tr>
  <form action="/scripts/za-holzarten.php?action=upd" method="post">
    <td><?php echo htmlentities($holzart['name']); ?></td>
