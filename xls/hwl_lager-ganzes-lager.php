...
// Seitenüberschrift
echo "<h1>EXCEL Tabellen des Massivholz Lagers (<a href='/xls/hwl_lager-ganzes-lager.php'>.XLS Tabellen</a>)</h1>";
...
$sql_holzarten = "
	...
	FROM
	  hwl_items
	  INNER JOIN za_holzarten ON (hwl_items.holzart = za_holzarten.id)
	GROUP BY
	  hwl_items.holzart
	ORDER BY
